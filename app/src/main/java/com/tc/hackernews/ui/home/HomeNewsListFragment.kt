...
class HomeNewsListFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mHackerViewModel = ViewModelProvider(this, mViewModelFactory)[HackerViewModel::class.java]
        initRecyclerView()
    ...
    private fun initRecyclerView() {
        mHackerViewModel.getStoryListLiveData().observe(viewLifecycleOwner, Observer {
            when (it.status) {
        ...
        mHackerViewModel.getAddMoreItemLiveData().observe(viewLifecycleOwner, Observer {
        ...
        search_list?.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {

            }

            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                var mTextLength = search_list.text.length

                mHackerNewsAdapter.filter.filter(search_list.text)
            }
